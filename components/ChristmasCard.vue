<template>
    <div class="w-full bg0red-500 h-full flex flex-col text-white text-7xl font-bold p-10 items-center justify-center"
        ...
        <div class="bg-red-500 px-2 py-2">De</div>
        <div> {{ name || 'Coloque seu nome aqui' }}</div>
    </div>
</template>
